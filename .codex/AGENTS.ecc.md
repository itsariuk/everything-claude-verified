...
## Command Workflows to Emulate

Use these ECC workflow templates as prompts:
- `commands/tdd.md` - Test-driven development workflow
- `commands/plan.md` - Create implementation plan
- `commands/code-review.md` - Review code quality
- `commands/build-fix.md` - Fix build errors
