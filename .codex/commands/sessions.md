...
```bash
node -e "
const sm = require((process.env.CODEX_ROOT||require('path').join(require('os').homedir(),'.codex'))+'/scripts/lib/session-manager');
const aa = require((process.env.CODEX_ROOT||require('path').join(require('os').homedir(),'.codex'))+'/scripts/lib/session-aliases');
