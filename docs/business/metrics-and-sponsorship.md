...
```bash
gh api repos/itsariuk/everything-claude-verified \
...
```bash
gh api repos/itsariuk/everything-claude-verified/traffic/views
gh api repos/itsariuk/everything-claude-verified/traffic/clones
```
