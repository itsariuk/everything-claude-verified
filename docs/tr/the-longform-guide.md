...
Kısa ve uzun kılavuzlarda ele alınan her şey GitHub'da mevcuttur: `github.com/itsariuk/everything-claude-verified`
...
*Oturum depolama örneği -> <https://github.com/itsariuk/everything-claude-verified/tree/main/examples/sessions>*
...
Bu hook'ları oluşturdum ve repo'da `github.com/itsariuk/everything-claude-verified/tree/main/hooks/memory-persistence` adresindeler
...
Bunu yapan bir sürekli öğrenme skill'i oluşturdum: `github.com/itsariuk/everything-claude-verified/tree/main/skills/continuous-learning`
...
*Her iki kılavuzda ele alınan her şey GitHub'da [everything-claude-code](https://github.com/itsariuk/everything-claude-verified) adresinde mevcuttur*
