...
/** Get the sessions directory (~/.codex/sessions) */
export function getSessionsDir(): string;

/** Get the learned skills directory (~/.codex/skills/learned) */
...
/**
 * Get short session ID from CODEX_SESSION_ID.
...
/** Log a message to stderr (visible to user in Codex terminal) */
export function log(message: string): void;

/** Output data to stdout (returned to Codex's context) */
