...
- **Rules are system-injected**: `.codex/rules/*.md` files load automatically every session. Unlike prompt instructions, the LLM cannot choose to ignore them.
...
- [Codex](https://docs.anthropic.com/en/docs/claude-code)
