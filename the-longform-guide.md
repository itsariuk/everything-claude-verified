...
Everything covered in the shorthand and longform guides is available on GitHub: `github.com/itsariuk/everything-claude-verified`
...
*Example of session storage -> <https://github.com/itsariuk/everything-claude-verified/tree/main/examples/sessions>*
...
I've built these hooks and they're in the repo at `github.com/itsariuk/everything-claude-verified/tree/main/hooks/memory-persistence`
...
I've built a continuous learning skill that does this: `github.com/itsariuk/everything-claude-verified/tree/main/skills/continuous-learning`
...
*Everything covered in both guides is available on GitHub at [everything-claude-code](https://github.com/itsariuk/everything-claude-verified)*
